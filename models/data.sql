...
START TRANSACTION;
USE `homefin`;
INSERT INTO `homefin`.`balance_type` (`id`, `order_code`, `name`, `balance_type_category_id`) VALUES (1, '1.1.', 'Активы', 1);
INSERT INTO `homefin`.`balance_type` (`id`, `order_code`, `name`, `balance_type_category_id`) VALUES (2, '2.1.', 'Текущий остаток', 2);
INSERT INTO `homefin`.`balance_type` (`id`, `order_code`, `name`, `balance_type_category_id`) VALUES (3, '2.2.', 'Резервы', 2);
INSERT INTO `homefin`.`balance_type` (`id`, `order_code`, `name`, `balance_type_category_id`) VALUES (4, '2.7.', 'Обязательства', 2);
INSERT INTO `homefin`.`balance_type` (`id`, `order_code`, `name`, `balance_type_category_id`) VALUES (5, '2.8.', 'Замороженные средства', 2);
...
-- -----------------------------------------------------
-- Data for table `homefin`.`ref_balance_item`
-- -----------------------------------------------------
START TRANSACTION;
USE `homefin`;
INSERT INTO `homefin`.`ref_balance_item` (`id`, `name`, `is_calculated`, `is_autogenerated`, `balance_type_id`, `knowledge_article_id`) VALUES (1, 'Текущий остаток', true, true, 2, NULL);
...
START TRANSACTION;
USE `homefin`;
INSERT INTO `homefin`.`system_settings` (`id`, `name`, `code`, `value`) VALUES (1, 'Порог расхождения баланса', 'balance_threshold', '0');
